...
public class LaufzeitanalyseDoublyLinkedList {

    private inc.boes.praktikum.classes.lists.DoublyLinkedList<Integer> myLinkedList = new inc.boes.praktikum.classes.lists.DoublyLinkedList<>();
    private java.util.LinkedList<Integer> javaLinkedList = new LinkedList<>();

    public LaufzeitanalyseDoublyLinkedList() {
    }

    public double[] addElements(int numberOfElements) {
        myLinkedList = new inc.boes.praktikum.classes.lists.DoublyLinkedList<>();
